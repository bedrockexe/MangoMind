...
class _MonthYieldsPageState extends State<MonthYieldsPage> {
  ...
  Future<void> _editRecordDialog(
    ...
    final kgCtrl = TextEditingController(
      text: (record.kg % 1 == 0)
          ? record.kg.toInt().toString()
          : record.kg.toStringAsFixed(1),
    );
    String type = record.type.isNotEmpty
        ? record.type
        : (YieldsHomePage._mangoTypes.isNotEmpty
              ? YieldsHomePage._mangoTypes.first
              : 'Others');
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    items: YieldsHomePage._mangoTypes
            ...
            FilledButton.icon(
              ...
              onPressed: saving
                  ...
                  : () async {
                      ...
                      try {
                        final kg =
                            double.tryParse(kgCtrl.text.trim()) ?? record.kg;
                        await widget.farmRef
                            .collection('yields')
                            .doc(record.id)
                            .update({
                              'weightKg': kg,
