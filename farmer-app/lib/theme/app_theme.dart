...
/// Centralized design system for MangoMind.
///
/// Everything visual flows from here: the color palette (mango-green +
/// amber/orange, matching the brand banner), typography, spacing scale, and
/// the shared component themes (cards, buttons, inputs, chips…). Screens should
/// read colors from `Theme.of(context).colorScheme.*` rather than hardcoding
/// `Colors.*`, so light/dark mode and any future rebrand "just work".
class AppTheme {
  AppTheme._();
